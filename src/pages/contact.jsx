...
export default function Contact() {
  ...
  const [company_size, setcompany_size] = useState("support");
  const [message, setmessage] = useState("");
  return (
    <div className="contact">
      <div className="first">
        <div className="right">
          <div className="title">Reach out to our professional</div>
          <div className="txt">
            We are here for you, leave a message and we will get back to you as
            soon as we can.
          </div>
          <form>
            <TextField
      ...
      <div className="second">
        ...
        <div className="content">
          ...
          <div className="">
            ...
            <span className="link">Check out FAQ</span>
          </div>
        </div>
      </div>
    </div>
